        ...
        <div className="max-w-4xl mx-auto space-y-8 animate-fade-in-up pb-10">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-8">
                <div className="relative group">
                    <div className="h-24 w-24 rounded-full overflow-hidden shadow-lg ring-4 ring-emerald-50 flex items-center justify-center bg-gradient-to-br from-emerald-500 to-teal-600">
                        {formData.avatar ? (
                            <img
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                        <h3 className="text-lg font-bold text-gray-800 mb-6 flex items-center">
                            <FaUser className="mr-2 text-emerald-500" /> Personal Details
                        </h3>
                    ...
                    {/* Social Links - Reuse same structure */}
